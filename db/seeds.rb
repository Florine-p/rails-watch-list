...
Wonder = { title: "Wonder Woman 1984", overview: "Wonder Woman comes into conflict with the Soviet Union during the Cold War in the 1980s", poster_url: "https://image.tmdb.org/t/p/original/8UlWHLMpgZm9bx6QYh0NFoq67TZ.jpg", rating: 6.9}
...
[ Wonder, Shawshank, Titanic, Ocean ].each do |attributes|
  ...
  100.times do 
    b = Bookmark.new(comment: Time.now, movie: Movie.all.sample, list: List.all.sample)
    b.save
    puts 'Creating 1 bookmark...'
  end 